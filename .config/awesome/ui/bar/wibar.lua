...
awesome_icon:buttons(gears.table.join(awful.button({}, 1,
        function()
...
local running = false
awesome.connect_signal("signal::charger",
        function(plugged)
            if plugged then
                g:again()
                running = true
...
date_text:connect_signal("widget::redraw_needed",
        function()
            date_text.markup = "<span foreground='" .. beautiful.xcolor11 .. "'>" ..
                    date_text.text .. "</span>"
        end)
...
time_text:connect_signal("widget::redraw_needed",
        function()
            time_text.markup = "<span foreground='" .. beautiful.xcolor5 .. "'>" .. time_text.text .. "</span>"
        end)
