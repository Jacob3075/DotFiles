...
options.completeopt = { "menuone", "noselect", "menu", "preview", "noinsert"} -- mostly just for cmp
...
options.showmode = true                        -- we don't need to see things like -- INSERT -- anymore
...
options.swapfile = true                        -- creates a swapfile
